...
发现token值，在html中搜索，找到了_token

发现了credits参数，用签到天数计算出来的，读文件步进

用BeautifulSoup库解析，跟js原生操作DOM很不一样，有点不适应（不过熟悉之后比原生DOM还是方便的多的）

### 2.  bmap? bmap.

bmap参数很显眼，查找是百度地图的api

```json
{"accuracy":null,"altitude":null,"altitudeAccuracy":null,"heading":null,"latitude":"43.82195350","longitude":"125.33060208","speed":null,"timestamp":null,"point":{"lng":125.33060208,"lat":43.8219535,"of":"inner"},"address":{"city":"","city_code":0,"district":"","province":"吉林省","street":"","street_number":""}}
```

就目前来讲暂时还是经纬度坐标和省的事情，至于市是自己填的就好说了

### 3. 定位伪造

#### 3.1 经纬度伪造

去google地图或者百度地图上找一个坐标就好了
